...
for i in range(len(run)):
    try:
        ...
        outfile='run'+str(run[i])+'_eventid'+str(eventid[i])+'_i3live_pass2.i3'
        ...
        add_truncated_energy_i3files.add_truncated_energy_i3file(int(run[i]),int(eventid[i]),'i3live_pass2')
        ...
        infile='run'+str(run[i])+'_eventid'+str(eventid[i])+'_i3live_pass2_te.i3'
